...
- 빈 줄은 주제가 전환되는 문단 사이에만 삽입
- 같은 주제의 연속 문장은 줄바꿈만 하고 빈 줄 없이 묶을 것
- 모든 줄 사이에 빈 줄을 넣지 말 것
- 호칭과 인사말은 빈 줄 없이 이어 쓰고, 인사말 뒤에 빈 줄
- 맺음말과 서명은 빈 줄 없이 이어 쓰고, 맺음말 앞에 빈 줄
...
- 원본의 줄바꿈과 빈 줄 패턴을 존중하세요. 오류가 아닌 줄바꿈을 추가하거나 제거하지 마세요.
